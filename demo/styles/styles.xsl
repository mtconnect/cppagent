...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:fn="http://www.w3.org/2005/xpath-functions"
  ...
  <xsl:template match="/">
    ...
    <body>
        ...
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            ...
            <div style="padding: 5px 5px">
              <li>
                <a style="color: white" href="/twin/index.html?device=Mazak">Mazak Digital Twin</a>
              </li>
              <li>
                <a style="color: white" href="/twin/index.html?device=OKUMA">Okuma Digital Twin</a>
              </li>
            </div>
          </div>
        </div>
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              <ul>
                ...
                <li> Mazak Twin Demo <a href="/twin">Mazak</a>
                </li>
                <li> Okuma Twin Demo <a href="/twin/index.html?device=OKUMA">Okuma</a>
                </li>
              </ul>
              ...
              <h4>About</h4>
              <p> For more information on MTConnect, see <a href="https://mtconnect.org">MTConnect.org</a> . </p>
      ...
      <script src="/styles/jquery-1.12.4.min.js"/>
        ...
        <tbody>
          <xsl:for-each select="//*">
            ...
            <xsl:variable name="rowStyle">
              <xsl:choose>
                <xsl:when test="$element = 'Header' or $element = 'Agent' or $element = 'Device'"> font-weight:bold; </xsl:when>
              </xsl:choose>
            </xsl:variable>
            ...
            <tr style="{$rowStyle}">
              ...
              <td>
                <div class="truncate">
                  ...
                  <!-- &#8196; -->
                  <!-- narrow space - see https://stackoverflow.com/questions/8515365/are-there-other-whitespace-codes-like-nbsp-for-half-spaces-em-spaces-en-space --> &#8196; <xsl:value-of
                    select="$element"/>
                </div>
              </td>
      ...
      <table class="table table-hover">
        ...
        <tbody>
          <xsl:for-each select="//*">
            ...
            <xsl:variable name="rowStyle">
              <xsl:choose>
                <xsl:when test="$element = 'Header' or $element = 'DeviceStream' or $element = 'Samples' or $element = 'Events' or $element = 'Conditions'"> font-weight:bold; </xsl:when>
              </xsl:choose>
            </xsl:variable>
