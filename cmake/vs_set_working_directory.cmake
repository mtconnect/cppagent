# By default Visual Studio sets its 'working directory' for debugging to the MSBuild property
# $(ProjectDir).
...
function(SetVisualStudioWorkingDirectory projectTarget workingDirectory)
  if(MSVC)
    set_target_properties(${projectTarget}
      PROPERTIES VS_DEBUGGER_WORKING_DIRECTORY "${workingDirectory}")
  endif()
endfunction()
