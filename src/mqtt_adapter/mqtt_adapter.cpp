...
namespace mtconnect
{
  ...
  namespace source
  {
    ...
    {
    public:
      MqttAdapterClient(boost::asio::io_context &ioContext, const ConfigOptions &options,
      ...
      bool start() override
      {
        ...
        m_client->set_connack_handler([this](bool sp,
      ...
      void stop() override { m_client.reset(); }
    ...
    protected:
      void subscribe()
      {
        ...
        m_client->async_subscribe(m_subPid, topicList, [](mqtt::error_code ec) {
          if (ec)
          {
      ...
      void reconnect()
      {
        ...
        m_reconnectTimer.async_wait([this](const boost::system::error_code &error) {
          if (error != boost::asio::error::operation_aborted)
          {
            ...
            // Connect
            m_client->async_connect([this](mqtt::error_code ec) {
    ...
    {
      m_client =
          make_shared<MqttAdapterClient<mqtt_client>>(m_ioContext, options, m_pipeline.get());
