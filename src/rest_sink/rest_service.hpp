...
public:
  ...
  // MTConnect Requests
  Response probeRequest(const Printer *, const std::optional<std::string> &device = std::nullopt);
  Response currentRequest(const Printer *, const std::optional<std::string> &device = std::nullopt,
