...
namespace mtconnect::ruby 
{
  ...
  protected:
    void createModule()
    {
      m_module = mrb_define_module(m_mrb, "MTConnect");
    }
    ...
    void defineLogger()
    {
      ...
      mrb_define_class_method(m_mrb, logger, "debug", [](mrb_state *mrb, mrb_value self) {
        log(::boost::log::trivial::debug, mrb);
        return mrb_nil_value();
      }, MRB_ARGS_REQ(1));
      mrb_define_class_method(m_mrb, logger, "trace", [](mrb_state *mrb, mrb_value self) {
        log(::boost::log::trivial::trace, mrb);
        return mrb_nil_value();
      }, MRB_ARGS_REQ(1));
      mrb_define_class_method(m_mrb, logger, "info", [](mrb_state *mrb, mrb_value self) {
        log(::boost::log::trivial::info, mrb);
        return mrb_nil_value();
      }, MRB_ARGS_REQ(1));
      mrb_define_class_method(m_mrb, logger, "warning", [](mrb_state *mrb, mrb_value self) {
        log(::boost::log::trivial::warning, mrb);
        return mrb_nil_value();
      }, MRB_ARGS_REQ(1));
      mrb_define_class_method(m_mrb, logger, "error", [](mrb_state *mrb, mrb_value self) {
        log(::boost::log::trivial::error, mrb);
        return mrb_nil_value();
      }, MRB_ARGS_REQ(1));
      mrb_define_class_method(m_mrb, logger, "fatal", [](mrb_state *mrb, mrb_value self) {
