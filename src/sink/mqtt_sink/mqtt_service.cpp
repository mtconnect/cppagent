...
//      }
//
//      sink::SinkPtr MqttService::create(boost::asio::io_context &io,
//                                        sink::SinkContractPtr &&contract,
//                                        const ConfigOptions &options,
//                                        const boost::property_tree::ptree &block)
//      {
//        return std::make_shared<MqttService>(io, std::move(contract), options, block);
//      }
//
//       void MqttService::register_factory(const boost::property_tree::ptree &block,
//                                         configuration::AgentConfiguration &config)
//      {
//        mtconnect::configuration::gAgentLogger = config.getLogger();
//        PLUGIN_LOG(debug) << "Registering sink factory for MqttService";
//        config.getSinkFactory().registerFactory("MqttService", &MqttService::create);
//      }
//
