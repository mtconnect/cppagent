...
public:
  ...
  explicit EntityError(const char *s, const std::string &e = "") : std::logic_error(s), m_entity(e)
  {}
...
{
public:
  explicit PropertyError(const std::string &s, const std::string &p = "", const std::string &e = "")
