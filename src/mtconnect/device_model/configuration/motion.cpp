    ...
    namespace configuration {
      FactoryPtr Motion::getFactory()
      {
        ...
        static auto motion = make_shared<Factory>(Requirements {
            ...
            Requirement("Description", false), Requirement("Axis", ValueType::VECTOR, 3, false), Requirement("AxisDataSet", ValueType::DATA_SET, false),
        ...
        motion->setOrder({"Description", "Axis", "AxisDataSet", "Origin", "OriginDataSet",
          "Transformation"});
