...
namespace mtconnect {
  ...
  namespace sink {
    ...
    namespace mqtt_sink {
      class AGENT_LIB_API MqttLegacyService : public sink::Sink
      {
      ...
      public:
        ...
        MqttLegacyService(boost::asio::io_context &context, sink::SinkContractPtr &&contract,
                          const ConfigOptions &options, const boost::property_tree::ptree &config);

        ~MqttLegacyService() = default;
