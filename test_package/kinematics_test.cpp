...
TEST_F(KinematicsTest, should_generate_data_xml_data_sets)
{
  ...
  
  {
    ...
    ASSERT_XML_PATH_EQUAL(doc, ROTARY_MOTION_PATH "/m:Transformation/m:TranslationDataSet/m:Entry[@key='X']", "10");
    ASSERT_XML_PATH_EQUAL(doc, ROTARY_MOTION_PATH "/m:Transformation/m:TranslationDataSet/m:Entry[@key='Y']", "20");
    ASSERT_XML_PATH_EQUAL(doc, ROTARY_MOTION_PATH "/m:Transformation/m:TranslationDataSet/m:Entry[@key='Z']", "30");
    
    ASSERT_XML_PATH_EQUAL(doc, ROTARY_MOTION_PATH "/m:Transformation/m:RotationDataSet/m:Entry[@key='A']", "90");
    ASSERT_XML_PATH_EQUAL(doc, ROTARY_MOTION_PATH "/m:Transformation/m:RotationDataSet/m:Entry[@key='B']", "0");
    ASSERT_XML_PATH_EQUAL(doc, ROTARY_MOTION_PATH "/m:Transformation/m:RotationDataSet/m:Entry[@key='C']", "180");
