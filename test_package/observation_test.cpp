...
TEST_F(ObservationTest, should_represent_inf_values_in_json_correctly)
{
  ErrorList errors;
  auto dataItem = DataItem::make(
...
/// @test Test handling of inf
TEST_F(ObservationTest, should_represent_nan_values_in_json_correctly)
{
  ErrorList errors;
  auto dataItem = DataItem::make(
      {{"id", "x"s}, {"category", "SAMPLE"s}, {"type", "TEMPERATURE"s}, {"units", "CELSIUS"s}},
...
/// @test Test handling of inf
TEST_F(ObservationTest, should_represent_negative_inf_values_in_json_correctly)
{
  ErrorList errors;
  auto dataItem = DataItem::make(
      {{"id", "x"s}, {"category", "SAMPLE"s}, {"type", "TEMPERATURE"s}, {"units", "CELSIUS"s}},
